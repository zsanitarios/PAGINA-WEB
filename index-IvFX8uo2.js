...
const logo = "/PAGINA-WEB/logo-zalazar-BOOowrGm.jpg";
function Navbar({ isStorePage = false }) {
  const [open, setOpen] = reactExports.useState(false);
  const homeHref = "/PAGINA-WEB/";
...
const comercioSanitarioPhoto = "/PAGINA-WEB/comercio-sanitario-zalazar-Buim6Gg9.jpg";
...
function _fetch(client2, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        __vitePreload(() => import("./stegaEncodeSourceMap-BmEmdERc.js"), true ? [] : void 0).then(function(n2) {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => __vitePreload(() => import("./browser-CBKoJptT.js").then((n2) => n2.b), true ? [] : void 0)).pipe(
...
const projectId = void 0;
const dataset = void 0;
