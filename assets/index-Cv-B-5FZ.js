...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-white/10 bg-black px-6 py-7", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-col gap-3 text-center text-sm text-zinc-400 sm:flex-row sm:items-center sm:justify-between sm:text-left", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "© 2026 Sanitarios Zalazar. Todos los derechos reservados." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Página desarrollada por ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-zinc-200", children: "JS Studio." })
    ] })
  ] }) });
}
...
const MessageCircleMore = createLucideIcon("message-circle-more", __iconNode$8);
...
const Store$1 = createLucideIcon("store", __iconNode$4);
const __iconNode$3 = [
  [
    "path",
    {
...
const logo = "/assets/logo-zalazar-BOOowrGm.jpg";
function Navbar({ isStorePage = false }) {
  const [open, setOpen] = reactExports.useState(false);
  const homeHref = "/";
  const storeHref = "#tienda";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: homeHref, className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.32em] text-brand-light", children: "Pilar" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-bold text-white", children: "Gas y Sanitarios Zalazar" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-3 md:flex", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: "https://wa.me/5491149708463?text=Hola%20Gas%20y%20Sanitarios%20Zalazar%2C%20quiero%20hacer%20una%20consulta.",
            target: "_blank",
            rel: "noreferrer",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircleMore, { className: "h-4 w-4" }),
              "Contacto"
            ]
          }
        )
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 bg-black md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 sm:px-6", children: [
...
const whatsappLink$1 = "https://wa.me/5491149708463?text=Hola%20Gas%20y%20Sanitarios%20Zalazar%2C%20quiero%20hacer%20una%20consulta.";
function WhatsAppButton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "a",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircleMore, { className: "h-8 w-8" })
    }
  );
}
const awaductLogo = "data:image/svg+xml;base64,";
const capeaLogo = "data:image/svg+xml;base64,";
const ferrumLogo = "data:image/svg+xml;base64,";
const fvLogo = "data:image/svg+xml;base64,";
const peiranoLogo = "data:image/svg+xml;base64,";
const rowaLogo = "data:image/svg+xml;base64,";
const saladilloLogo = "data:image/svg+xml;base64,";
const sigasLogo = "data:image/svg+xml;base64,";
const waterplastLogo = "data:image/svg+xml;base64,";
const highlights = [
  "Waterplast",
  "FV",
  "Rowa",
...
function BrandCard({ brand }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "w-[230px] shrink-0 overflow-hidden rounded-[1.75rem] border border-white/10 bg-white shadow-panel sm:w-[280px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: brand.image,
      alt: `Logo de ${brand.name}`,
      className: "h-[130px] w-full object-cover sm:h-[155px]"
    }
  ) });
}
function CarouselTrack() {
  const slides = [...brandSlides, ...brandSlides];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-max animate-marquee gap-5 pr-5 will-change-transform", children: slides.map((brand, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(BrandCard, { brand }, `${brand.name}-${index}`)) });
}
function BrandsGallery() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "marcas", className: "overflow-hidden bg-black py-20 sm:py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full border border-brand/25 bg-brand/10 px-4 py-2 text-sm font-semibold uppercase tracking-[0.2em] text-brand-light", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "h-4 w-4" }),
          "Marcas"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-5 text-3xl font-bold text-white sm:text-4xl", children: "Galeria de marcas con las que trabajamos" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-zinc-400", children: "Trabajamos con marcas reconocidas en sanitarios, griferia, termofusion, tanques y bombas para cubrir distintas necesidades de obra." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: highlights.map((brand) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeCheck, { className: "h-4 w-4 text-brand-light" }),
            brand
          ]
        },
        brand
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 left-0 z-10 w-24 bg-gradient-to-r from-black to-transparent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-gradient-to-l from-black to-transparent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselTrack, {})
    ] })
  ] });
}
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(47,110,214,0.42),_transparent_26%),radial-gradient(circle_at_bottom_left,_rgba(255,255,255,0.08),_transparent_24%)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-ink to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-semibold backdrop-blur", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeCheck, { className: "h-4 w-4" }),
              "Asesoramiento para obra y remodelacion"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-8 max-w-3xl text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl", children: "Gas y Sanitarios Zalazar" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-6 max-w-2xl text-lg leading-8 text-zinc-200 sm:text-xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: "💧| Aguas, Tanques y Grifería." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: "👷| Gas, Loza Sanitaria y lo principal para tu Obra." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: "🕒| 20 Años en el Rubro" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 flex flex-col gap-4 sm:flex-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    "Ver tienda",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "h-5 w-5" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-[2rem] border border-white/10 bg-panel p-6 shadow-panel backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-3xl border border-brand-light/40 bg-white p-5 text-slate-950", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: fvLogo,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.25em] text-brand", children: "FV" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-lg font-black", children: "Representantes Oficiales de FV en Zona Norte" })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-3xl border border-white/10 bg-white p-5 text-slate-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl bg-brand-light p-3 text-brand", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "h-6 w-6" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold uppercase tracking-[0.25em] text-brand", children: "Sucursal" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-lg font-bold", children: "Av. Tomas Marquez 1248, Pilar" })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-3xl border border-white/10 bg-black/30 p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl bg-white/15 p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { className: "h-6 w-6" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold uppercase tracking-[0.25em] text-white/80", children: "Materiales seleccionados" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-lg font-semibold", children: "Griferia, termotanques, caños, sanitarios y mas para resolver tu compra en un solo lugar." })
              ] })
            ] }) })
          ] }) })
        ] })
...
const comercioSanitarioPhoto = "/assets/comercio-sanitario-zalazar-Buim6Gg9.jpg";
const videoUrl = "https://www.youtube.com/watch?v=Lg_jb9Fdf-0";
function IndustryTalk() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-ink px-6 py-16 sm:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-white/10 bg-panel shadow-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[1.05fr_0.95fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: videoUrl,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 bg-gradient-to-t from-black/65 via-transparent to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-6 left-6 inline-flex items-center gap-2 rounded-full bg-red-600 px-4 py-2 text-sm font-bold text-white shadow-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "h-4 w-4 fill-current", "aria-hidden": "true" }),
            "Ver en YouTube"
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center p-7 sm:p-10 lg:p-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold uppercase tracking-[0.24em] text-brand-light", children: "Comercio Sanitario · Episodio N°9" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-3xl font-extrabold tracking-tight text-white sm:text-4xl", children: "Sanitarios Zalazar, presentes en la charla" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-base leading-relaxed text-zinc-300 sm:text-lg", children: "Participamos de una conversación junto a referentes del sector para compartir experiencia, actualidad y el trabajo que hacemos todos los días." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: videoUrl,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { className: "h-5 w-5 text-red-600", "aria-hidden": "true" }),
...
const mapsLink$1 = "https://www.google.com/maps?sca_esv=2cda95c598b12d52&output=search&q=sanitarios+zalazar&source=lnms&fbs=ADc_l-bpk8W4E-qsVlOvbGJcDwpn4CbM0gHaMP9RLFWGd8kHNhTJmj_r203Jn6uBSzsvMQA06cx6S_-rciuKUa3AoaNQ_ldwmJy4IAzDctR5xPsLWyUNTq_UcLXfQw50cBroztmRfskeWnY5V8Wmj_Ji7zfSNNt-NCdO-ekZlrNuvjUo8NY7rSIzI-8eZZCZ3Bz9rM_M41ZVC8hlrnmY8wprb2ASJs4-UA&entry=mc&ved=1t:200715&ictx=111";
function LocationSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "ubicacion", className: "bg-black py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-white/10 bg-panel p-8 text-white shadow-panel backdrop-blur", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full border border-brand/20 bg-brand/10 px-4 py-2 text-sm font-semibold uppercase tracking-[0.2em] text-brand-light", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPinned, { className: "h-4 w-4" }),
        "Ubicacion"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-6 text-3xl font-bold sm:text-4xl", children: "Visitanos en Pilar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-zinc-300", children: "Estamos para asesorarte en cada etapa de tu obra, remodelacion o mantenimiento." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-xl font-semibold text-white", children: "Av. Tomas Marquez 1248, Pilar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          href: mapsLink$1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-3xl border border-white/10 bg-zinc-950 shadow-panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: mapsLink$1,
        target: "_blank",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold uppercase tracking-[0.3em] text-brand-light", children: "Punto de venta" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-3 text-3xl font-bold text-white", children: "Ubicacion y acceso rapido" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-md text-zinc-400", children: "Consulta la ubicacion exacta del local y abre el recorrido directo desde Google Maps." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 rounded-3xl border border-white/10 bg-white/5 p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm uppercase tracking-[0.25em] text-zinc-500", children: "Direccion" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-2xl font-semibold text-white", children: "Av. Tomas Marquez 1248" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-zinc-400", children: "Pilar, Buenos Aires" })
          ] })
        ]
      }
    ) })
...
const whatsappLink = "https://wa.me/5491149708463?text=Hola%20Gas%20y%20Sanitarios%20Zalazar%2C%20quiero%20pedir%20un%20presupuesto.";
function QuoteCta() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-white/10 bg-brand-dark px-6 py-12 sm:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-6xl flex-col items-start justify-between gap-7 rounded-3xl border border-white/15 bg-white/10 p-7 shadow-panel backdrop-blur-sm sm:flex-row sm:items-center sm:p-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold uppercase tracking-[0.24em] text-brand-light", children: "Para tu obra o remodelación" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 text-3xl font-extrabold tracking-tight text-white sm:text-4xl", children: "PRESUPUESTÁ YA" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-xl text-base leading-relaxed text-white/75", children: "Contanos qué necesitás y te ayudamos a armar el presupuesto ideal." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircleMore, { className: "h-5 w-5", "aria-hidden": "true" }),
          "Pedí tu presupuesto"
        ]
      }
    )
...
const localZalazar = "/assets/local-zalazar-C9ys6hNf.jpg";
const mapsLink = "https://www.google.com/maps?sca_esv=2cda95c598b12d52&output=search&q=sanitarios+zalazar&source=lnms&fbs=ADc_l-bpk8W4E-qsVlOvbGJcDwpn4CbM0gHaMP9RLFWGd8kHNhTJmj_r203Jn6uBSzsvMQA06cx6S_-rciuKUa3AoaNQ_ldwmJy4IAzDctR5xPsLWyUNTq_UcLXfQw50cBroztmRfskeWnY5V8Wmj_Ji7zfSNNt-NCdO-ekZlrNuvjUo8NY7rSIzI-8eZZCZ3Bz9rM_M41ZVC8hlrnmY8wprb2ASJs4-UA&entry=mc&ved=1t:200715&ictx=111";
function VisitStore() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-black px-6 py-16 sm:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl overflow-hidden rounded-[2rem] border border-white/10 bg-panel shadow-panel lg:grid-cols-[1.05fr_0.95fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: mapsLink,
        target: "_blank",
        rel: "noreferrer",
        "aria-label": "Abrir la ubicación de Sanitarios Zalazar en Google Maps",
        className: "group relative block min-h-72 overflow-hidden bg-brand-dark lg:min-h-full",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: localZalazar,
              alt: "Interior del local de Gas y Sanitarios Zalazar en Pilar",
              className: "h-full w-full object-cover transition duration-500 group-hover:scale-105"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-6 left-6 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-bold text-black shadow-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 text-brand", "aria-hidden": "true" }),
            "Cómo llegar"
          ] })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center p-7 sm:p-10 lg:p-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold uppercase tracking-[0.24em] text-brand-light", children: "Te esperamos en Pilar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-3xl font-extrabold tracking-tight text-white sm:text-4xl", children: "Vení a visitar nuestro negocio" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-base leading-relaxed text-zinc-300 sm:text-lg", children: "Recorré el local, conocé las opciones y encontrá todo lo que necesitás para tu obra o remodelación. Estamos para asesorarte en persona." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: mapsLink,
          target: "_blank",
          rel: "noreferrer",
          className: "mt-8 inline-flex w-fit items-center gap-3 rounded-full bg-brand px-6 py-3.5 text-sm font-bold text-white transition hover:bg-brand-dark focus:outline-none focus:ring-2 focus:ring-brand-light focus:ring-offset-2 focus:ring-offset-ink",
          children: [
...
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BrandsGallery, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VisitStore, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IndustryTalk, {}),
...
function ProductCard({ product }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "group overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-950 shadow-panel transition duration-300 hover:-translate-y-1 hover:border-brand/50 hover:shadow-soft", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/3] overflow-hidden bg-zinc-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: product.image,
        alt: product.title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
        product.category ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full bg-brand/15 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-brand-light", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: "h-3.5 w-3.5" }),
          product.category
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-zinc-400", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: "h-3.5 w-3.5" }),
          "Producto"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-right text-lg font-extrabold text-brand", children: hasPrice ? formatPrice(product.price) : "Consultar precio" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-4 text-xl font-bold text-white", children: product.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-6 text-zinc-400", children: product.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: `https://wa.me/5491149708463?text=${message}`,
          target: "_blank",
          rel: "noreferrer",
...
function Store({ products }) {
  ...
  const productsByCategory = activeCategory === "Todos" ? products : products.filter((product) => product.category === activeCategory);
  const normalizedSearch = searchTerm.trim().toLowerCase();
  const visibleProducts = normalizedSearch ? productsByCategory.filter((product) => {
    const searchableText = [product.title, product.category, product.description].filter(Boolean).join(" ").toLowerCase();
    return searchableText.includes(normalizedSearch);
  }) : productsByCategory;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "tienda", className: "border-y border-white/5 bg-ink py-20 sm:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full border border-brand/25 bg-brand/10 px-4 py-2 text-sm font-semibold uppercase tracking-[0.2em] text-brand-light", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "h-4 w-4" }),
        "Catalogo"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-5 text-3xl font-bold text-white sm:text-4xl", children: "Productos destacados para tu obra" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-zinc-400", children: "Una seleccion clara de productos para consultar disponibilidad, precio y alternativas por WhatsApp." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 flex gap-3 overflow-x-auto pb-2", children: categories.map((category) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: `inline-flex shrink-0 items-center gap-3 rounded-full border px-5 py-3 text-sm font-semibold transition ${isActive ? "border-brand bg-brand text-white" : "border-white/10 bg-white/5 text-zinc-300 hover:border-brand/40 hover:text-white"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: category }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `rounded-full px-2 py-0.5 text-xs ${isActive ? "bg-white/20 text-white" : "bg-white/10 text-zinc-400"}`,
                children: count
              }
            )
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "product-search", className: "sr-only", children: "Buscar producto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "pointer-events-none absolute left-5 top-1/2 h-5 w-5 -translate-y-1/2 text-brand-light" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "product-search",
    ...
    visibleProducts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid gap-6 sm:grid-cols-2 xl:grid-cols-4", children: visibleProducts.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product }, product.id)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 rounded-[2rem] border border-white/10 bg-white/5 p-8 text-center text-zinc-300", children: "No encontramos productos con esa busqueda." })
  ] }) });
}
const fallbackProducts = [
  ...
  },
  {
    ...
    price: 19400,
    category: "Tuberías",
    image: "https://images.unsplash.com/photo-1574359411659-15573f979f55?auto=format&fit=crop&w=900&q=80",
  ...
  },
  {
    ...
    price: 228400,
    category: "Bombas",
    image: "https://images.unsplash.com/photo-1618220048045-10a6dbdf83e0?auto=format&fit=crop&w=900&q=80",
...
const VALID_ASSET_TYPES = ["image", "file"], VALID_INSERT_LOCATIONS = ["before", "after", "replace"], dataset$1 = (name) => {
...
function validateApiVersion(apiVersion2) {
  if (apiVersion2 === "1" || apiVersion2 === "X")
    return;
  const apiDate = new Date(apiVersion2);
  if (!(/^\d{4}-\d{2}-\d{2}$/.test(apiVersion2) && apiDate instanceof Date && apiDate.getTime() > 0))
...
function _fetch(client2, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        __vitePreload(() => import("./stegaEncodeSourceMap-CKrezcHe.js"), true ? [] : void 0).then(function(n2) {
...
function _requestObservable(client2, httpRequest, options) {
  const uri = options.url || options.uri, config2 = client2.config(), canUseCdn = typeof options.canUseCdn > "u" ? ["GET", "HEAD"].indexOf(options.method || "GET") >= 0 && isData(client2, uri) : options.canUseCdn;
  let useCdn2 = (options.useCdn ?? config2.useCdn) && canUseCdn;
  ...
  if (tag && options.tag !== null && (options.query = { tag: requestTag(tag), ...options.query }), ["GET", "HEAD", "POST"].indexOf(options.method || "GET") >= 0 && isQuery(client2, uri)) {
    ...
    perspectiveOption === "previewDrafts" || perspectiveOption === "drafts") && useCdn2 && (useCdn2 = false, printCdnPreviewDraftsWarning())), options.lastLiveEventId && (options.query = { ...options.query, lastLiveEventId: options.lastLiveEventId }), options.returnQuery === false && (options.query = { returnQuery: "false", ...options.query }), useCdn2 && options.cacheMode == "noStale" && (options.query = { cacheMode: "noStale", ...options.query });
  }
  const reqOptions = requestOptions(
    config2,
    Object.assign({}, options, {
      url: _getUrl(client2, uri, useCdn2)
    })
...
function _upload(client2, httpRequest, assetType, body, opts = {}) {
  ...
  const config2 = client2.config(), options = optionsFromFile(opts, body), { tag, label, title, description, creditLine, filename, source } = options, isMediaLibrary = config2.resource?.type === "media-library", query = isMediaLibrary ? {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => __vitePreload(() => import("./browser-B3uuJl1E.js").then((n2) => n2.b), true ? [] : void 0)).pipe(
...
class LiveClient {
  ...
  events({
    ...
    } = this.#client.config(), apiVersion2 = _apiVersion.replace(/^v/, "");
    if (apiVersion2 !== "X" && apiVersion2 < requiredApiVersion)
      throw new Error(
        `The live events API requires API version ${requiredApiVersion} or later. The current API version is ${apiVersion2}. Please update your API version to use this feature.`
      );
...
class ObservableDatasetsClient {
  ...
  getEmbeddingsSettings(name) {
    return resourceGuard("dataset", this.#client.config()), dataset$1(name), _request(this.#client, this.#httpRequest, {
...
class DatasetsClient {
   ...
   */
  getEmbeddingsSettings(name) {
    return resourceGuard("dataset", this.#client.config()), dataset$1(name), lastValueFrom(
...
function _embeddingsSettingsUri(client2, name) {
  const config2 = client2.config();
...
function _modify(client2, httpRequest, method, name, options) {
  return resourceGuard("dataset", client2.config()), dataset$1(name), _request(client2, httpRequest, {
    method,
    uri: `/datasets/${name}`,
    body: options,
    tag: null
...
var imageUrl_umd$1 = { exports: {} };
var imageUrl_umd = imageUrl_umd$1.exports;
var hasRequiredImageUrl_umd;
...
var imageUrl_umdExports = /* @__PURE__ */ requireImageUrl_umd();
const imageUrlBuilder = /* @__PURE__ */ getDefaultExportFromCjs(imageUrl_umdExports);
const projectId = "dzwofxfq";
const dataset = "production";
const apiVersion = "2026-04-29";
const useCdn = true;
const sanityEnabled = Boolean(dataset);
...
function useProducts() {
  const [products, setProducts] = reactExports.useState(fallbackProducts);
  const [loading, setLoading] = reactExports.useState(sanityEnabled);
...
function StorePage() {
  const { products, loading, error, sanityEnabled: sanityEnabled2 } = useProducts();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-ink pt-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-b border-white/5 bg-[radial-gradient(circle_at_top,_rgba(0,71,171,0.18),_transparent_40%),linear-gradient(180deg,_#060606,_#0b0b0b)] py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: "/",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 rounded-full border border-brand/25 bg-brand/10 px-4 py-2 text-sm font-semibold uppercase tracking-[0.2em] text-brand-light", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Store$1, { className: "h-4 w-4" }),
          "Tienda"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-5 text-4xl font-bold text-white sm:text-5xl", children: "Catalogo completo de productos" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-zinc-400", children: "Explora por categoria y consulta cada producto de forma directa por WhatsApp." }),
        !sanityEnabled2 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 max-w-2xl rounded-2xl border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-100", children: "Sanity todavia no esta conectado en esta copia. La tienda muestra productos de ejemplo hasta que cargues las variables del proyecto." }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 max-w-2xl rounded-2xl border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-100", children: error })
      ] })
    ] }) }),
    loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4 pt-10 text-sm text-zinc-400 sm:px-6 lg:px-8", children: "Cargando catalogo..." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Store, { products })
  ] });
}
function App() {
  const [pathname, setPathname] = reactExports.useState(`${window.location.pathname}${window.location.hash}`);
  reactExports.useEffect(() => {
    const handleNavigation = () => setPathname(`${window.location.pathname}${window.location.hash}`);
  ...
  const isStorePage = pathname.endsWith("#tienda");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-ink text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { isStorePage }),
    isStorePage ? /* @__PURE__ */ jsxRuntimeExports.jsx(StorePage, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}),
