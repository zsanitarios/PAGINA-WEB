...
const whatsappLink$1 = "https://wa.me/5491140935336?text=Hola%20Gas%20y%20Sanitarios%20Zalazar%2C%20quiero%20hacer%20una%20consulta.";
...
const whatsappLink = "https://wa.me/5491140935336?text=Hola%20Gas%20y%20Sanitarios%20Zalazar%2C%20quiero%20pedir%20un%20presupuesto.";
function QuoteCta() {
...
function _fetch(client2, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        __vitePreload(() => import("./stegaEncodeSourceMap-NsbMCh6-.js"), true ? [] : void 0).then(function(n2) {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => __vitePreload(() => import("./browser-C3h00gMA.js").then((n2) => n2.b), true ? [] : void 0)).pipe(
