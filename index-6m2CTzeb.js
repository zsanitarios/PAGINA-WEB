...
function _fetch(client2, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        __vitePreload(() => import("./stegaEncodeSourceMap-CT2BpkeT.js"), true ? [] : void 0).then(function(n2) {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => __vitePreload(() => import("./browser-DlFYkvli.js").then((n2) => n2.b), true ? [] : void 0)).pipe(
